...
extension JFShoppingCartViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return addGoodArray?.count ?? 0 // ShopViewController.itemNamesAndImageUrls[UserClickedAtIndex].count // UserClickedAtIndex is segued over when user clicks on a tableViewCell in subsubCategories VC
    }
